                ...
                <div className="w-11/12 sm:w-9/12 md:w-8/12 lg:w-6/12 xl:w-5/12">
                    <div className="flex flex-col">
                        <h2 className="text-lg font-bold mb-1 text-white text-center text-5xl p-3">
                            Shift Products (Order To Ready Made)
                        </h2>
                        {/* Input fields */}
                        <div className="mb-4">
                            <label className="text-white">Old Product ID:</label>
                            <input
                                type="text"
                        ...
                        <div className="mb-4">
                            <label className="text-white">Confirm Old Product ID:</label>
                            <input
                                type="text"
                                placeholder="Enter product ID"
                                value={ConOldProductid}
                                onChange={(e) => setConOldProductid(e.target.value)}
                                className="w-full border border-gray-300 p-2"
                            />
                        </div>
                        <div className="mb-4">
...
export default OrderToReadyMade;
