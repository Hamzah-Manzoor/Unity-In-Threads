        ...
        aria-label="Sidebar">
          <div className="h-full px-3 pb-4 overflow-y-auto bg-gray-800">
            <ul className="space-y-2 font-medium">
              <li>
                <Link to="/retail/dashboard" className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                  <svg
              ...
              <li>
                ...
                >
                  ...
                  <li>
                    <Link to="#" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Resume Order Entry</Link>
                  </li>
                  <li>
                    <Link to="#" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Order Delivery</Link>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                >
                  <li>
                    <Link to="/retail/new-bill" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">New Bill</Link>
                  </li>
                  <li>
                    <Link to="/retail/update-bill" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Update Bill</Link>
                  </li>
                  <li>
                    <Link to="#" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Hold Product(s)</Link>
                  </li>
                  <li>
                    <Link to="#" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Refund Bill</Link>
                  </li>
                </ul>
              </li>
              ...
              <li>
              {/* /products */}
                <Link to="/retail/products" className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
              ...
              {/* <li>
                <a href="/retail/record-retail-order" className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
              ...
              <li>  
                <Link to="/retail/return-and-exchange" className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
