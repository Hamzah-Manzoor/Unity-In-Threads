            ...
            <ul className="space-y-2 font-medium">
              ...
              <li>
                ...
                >
                  ...
                  <li>
                    <Link to="#" className="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">New Order</Link>
                  </li>
                  <li>
                    <Link to="#" className="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">Resume Order Entry</Link>
                  </li>
                  <li>
                    <Link to="#" className="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">Order Delivery</Link>
                  </li>
                </ul>
              </li>
